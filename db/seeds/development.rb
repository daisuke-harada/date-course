...
DateSpot.find_by(id: 1).image.attach(io: File.open('app/assets/images/date_spot_images/canal.jpeg'),
                                     filename: 'canal.jpeg')
Address.create(prefecture_id: 40, date_spot_id: 1, city_name: "福岡市博多区住吉1丁目2")
...
Address.create(prefecture_id: 40, date_spot_id: 2, city_name: "福岡市中央区大名1-11-22-1")
...
Address.create(prefecture_id: 12, date_spot_id: 3, city_name: "浦安市舞浜1-1")
...
Address.create(prefecture_id: 13, date_spot_id: 5, city_name: "渋谷区恵比寿4丁目20 ガーデンプレイス")
