...
export const NavBar: VFC<Props> = memo((props) => {
  ...
  return(
    <ul className={`${isOpen? `-translate-y-0`: `-translate-y-96`} lg:hidden sm:top-24 duration-500 fixed top-20 text-center border border-red-100 bg-red-100 z-40 w-2/3 right-0`}>
